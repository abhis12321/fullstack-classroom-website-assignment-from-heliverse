...
export default function ClassRoomForm({ setOption }) {
    ...
    return (
        <div className="fixed top-0 left-0 z-50 h-[100vh] w-full flex items-center justify-center bg-gray-700/90" >
            <form className="w-[98%] max-w-[700px] gap-1 flex flex-col items-center justify-center p-6 bg-white text-red-950 font-semibold shadow-[0_0_10px_gray_inset] rounded-lg" onSubmit={handleSubmit}>
...

                {
                    timeTable.map((data, index) =>
                        <div className="flex justify-between items-center gap-2 w-[98%] max-w-[600px]" key={index}>
